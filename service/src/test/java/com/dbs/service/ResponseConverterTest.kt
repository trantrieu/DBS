...
internal class ResponseConverterTest {
    ...
    fun convertArticle_givenListArticleResponse_returnListArticle() {
        ...
        assertEquals(actual[0].shortDescription, "This is article 1 short description. She wholly fat who window extent either formal. Removing welcomed civility or hastened is.")
        ...
        assertEquals(actual[1].shortDescription, "This is article 2 short description. She wholly fat who window extent either formal. Removing welcomed civility or hastened is.")
    ...
    private fun getListArticleResponse() = listOf(
        ArticleResponse(1, "article 1 title", 1586404611, "This is article 1 short description. She wholly fat who window extent either formal. Removing welcomed civility or hastened is.", "https://minotar.net/avatar/user2"),
        ArticleResponse(2, "article 2 title", 1506404611, "This is article 2 short description. She wholly fat who window extent either formal. Removing welcomed civility or hastened is.", "https://minotar.net/avatar/user3")
    )
